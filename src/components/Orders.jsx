...
const Orders = () => {
  ...
  return (
    <motion.div
     ...
     className='w-[100%] min-h-[100vh] pb-[250px] md:pb-0'>
      <h1 className='text-center font-bold text-blue-700 text-[30px]  py-[100px]'>Orders Summary</h1>
      {
       ...
       <div className='w-[90%] mx-auto flex gap-[100px] flex-col md:flex-row'>
          <div className=" md:w-[60%] w-[100%] h-[300px] overflow-y-auto  py-[70px] flex flex-col gap-[20px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
               {
                 cart?.map((item)=><div className=' w-[95%] mx-auto h-[100px]  border-b-[2px] pb-[15px] border-b-blue-400 flex justify-center items-center gap-[30px] md:gap-[70px]'>
          ...
          <div className='md:w-[40%] w-[100%]'>
            <div className='md:w-[80%] w-[95%] mx-auto md:mx-0 h-[300px]  shadow-2xl bg-blue-400 rounded-lg shadow-gray-400   border-green-500 mt-[100px] px-[20px] py-[20px]'>
